...
require_relative "../../lib/musicology/ring_item_methods"

describe Musicology::RingItemMethods do
  describe "#+" do
    it "returns the RingItem N indices clockwise around the ring" do
      ring = Musicology::Ring.new(TestRingItemWrapper, ["a", "b", "c", "d"])
